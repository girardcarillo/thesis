...
We show in Fig.~\ref{fig:real_target_act} the $90$~\%~CL $\Tbeta$ limit as a function of the contamination levels, as well as the corresponding chosen region of interest.
\begin{figure}[h!]
  \centering
...
In Tab.~\ref{tab:eff_Nd_ROI} we give the expected number of background events in the optimised ROI [$3.1$;$3.55$]~MeV.
\begin{table}[h!]
  \centering
  \begin{tabular}{|c|c|c|}
    \hline
    Process & Selenium & Neodynium \\
    & [$2.7$;$3.15$]~MeV & [$3.1$;$3.55$]~MeV \\
    \hline\hline
    $\epsilon_{0\nu}$ (\%) & $14.4$ & $10.3$ \\
    $\twonu$  & $0.39$ & $0.28$ \\
    \Tl  & $0.044$ & $0.029$ \\
